...
module Dot = {
  ...
  external obj: Js.t(_) => t = "%identity";
  external render: (Js.t(_) => React.element) => t = "%identity";
};
...
module Make = (Config: {
  ...
  module XAxis = {
    ...
    type label;
    external obj: Js.t(_) => label = "%identity";
  ...
  module YAxis = {
    ...
    external make:
      (
        ~_type: [@bs.string] [ | `number]=?,
        ~scale: [@bs.string] [ | `log | `linear]=?,
  ...
  module Tooltip = {
    ...
    [@bs.module "recharts"] [@react.component]
    external make: (~content: data => React.element=?) => React.element =
      "Tooltip";
  };
  module CartesianGrid = {
    [@bs.module "recharts"] [@react.component]
    external make: (~strokeDasharray: string=?) => React.element =
      "CartesianGrid";
  };
  module Label = {
    [@bs.module "recharts"] [@react.component]
